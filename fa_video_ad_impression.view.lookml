- view: fa_video_ad_impression
  ...
  - dimension: num_complete_impressions
    type: number
    sql: ${TABLE}.num_complete_impressions

  - dimension: num_default_impressions
    type: number
    sql: ${TABLE}.num_default_impressions

  - dimension: num_first_quartile_impressions
    type: number
    sql: ${TABLE}.num_first_quartile_impressions

  - dimension: num_midpoint_impressions
    type: number
    sql: ${TABLE}.num_midpoint_impressions

  - dimension: num_third_quartile_impressions
    type: number
    sql: ${TABLE}.num_third_quartile_impressions
